...
import {players} from "../constants/cron-tasks.constants";
import {Client, ClientKafka} from "@nestjs/microservices";
import { topics } from "../../kafka/topics";


@Injectable()
export class LiveDropsUseCase {
    constructor(
        @Inject('API_APP_CLIENT') private client: ClientKafka,
    ) {}
    ...
    liveDropsBotRun() {
        ...
        // this.client.emit(topics.cases.caseOpened, {data: "data"});
    }
