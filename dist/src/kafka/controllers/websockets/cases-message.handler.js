...
exports.CasesMessageHandler = void 0;
...
let CasesMessageHandler = class CasesMessageHandler {
    constructor(liveDropsStore, statisticsStore) {
        this.liveDropsStore = liveDropsStore;
        this.statisticsStore = statisticsStore;
    }
};
CasesMessageHandler = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [live_drops_store_service_1.default,
        statistics_store_service_1.default])
], CasesMessageHandler);
exports.CasesMessageHandler = CasesMessageHandler;
//# sourceMappingURL=cases-message.handler.js.map